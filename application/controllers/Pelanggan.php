...
class Pelanggan extends CI_Controller {
	...
	public function update_pelanggan()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if($proses_update){
				...
				$this->session->set_flashdata('pesan', '<div class="alert alert-danger">gagal update');
			}
			redirect(base_url('index.php/pelanggan'),'refresh');
		}
	}
	public function hapus_pelanggan($id_pelanggan='')
	{
		...
		if($hapus){
			$this->session->set_flashdata('pesan', '<div class="alert alert-success">sukses hapus data</div>');
			} else {
				$this->session->set_flashdata('pesan', '<div class="alert alert-danger">gagal hapus data');
			}
			redirect(base_url('index.php/pelanggan'),'refresh');
	}
